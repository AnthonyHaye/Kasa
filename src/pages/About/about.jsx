...
const aboutDropdown = [
  ...
  {
    title : "Service", 
    paragraph : "La qualité du service est au coeur de notre engagement chez Kasa. Nous veillons à ce que chaque interaction, que ce soit avec nos hôtes ou nous locataires, soit empreinte de respect et de bienveillance."
  },
  {
    title : "Sécurité", 
      ...
      <div className="main">
        <div className="aboutDropdown">
          {aboutDropdown.map((item) => (
              <Dropdown title={item.title}>  {item.paragraph}</Dropdown>                
          ))}
        </div>        
      </div>
      <Footer />
